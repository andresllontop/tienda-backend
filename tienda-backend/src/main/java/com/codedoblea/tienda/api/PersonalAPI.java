...
import com.codedoblea.tienda.dao.impl.PersonalDAOImpl;
...
public class PersonalAPI {
    ...
    private static final Logger LOG = Logger.getLogger(PersonalAPI.class.getName());
    ...
    public Response paginate(
        ...
        return Response.status(Response.Status.OK)
                .entity(this.personalDAO.getPagination(parameters))
                .build();
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response add(Personal personal) throws SQLException {
        LOG.info(personal.toString());
        return Response.status(Response.Status.OK)
                .entity(this.personalDAO.add(personal, ParametersDefault.getParametersDefault()))
                .build();
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response update(Personal personal) throws SQLException {
        LOG.info(personal.toString());
        return Response.status(Response.Status.OK)
                .entity(this.personalDAO.update(personal, ParametersDefault.getParametersDefault()))
                .build();
    }
    ...
    public Response delete(@PathParam("id") Long id) throws SQLException {
        ...
        return Response.status(Response.Status.OK)
                .entity(this.personalDAO.delete(id, ParametersDefault.getParametersDefault()))
                .build();
    }
